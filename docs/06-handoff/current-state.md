...
Follow `docs/05-experiments/next-experiment.md`:

1. Verify case and mechanism sources for the lift governor.
2. Fully package the lift governor, oxygen-mask generator and airbag sensor.
3. Obtain human approval for the selected package and script.
4. Build and time the complete pilot.
