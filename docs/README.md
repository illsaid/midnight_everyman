...
- `01-product/launch-validation.md` — organic test boundary, scale-aware analytics and owned-audience timing
...
- `02-creative/diagram-layer.md` — schematic diagram system, frame geometry and motion timing in frames
...
- `04-production/retention-structure.md` — the four layers, retention devices and the skeleton
- `04-production/quality-gates.md` — acceptance criteria
- `04-production/repository-and-media-policy.md` — GitHub/local-media boundary and multi-agent rules
- `04-production/remotion-workflow-notes.md` — implementation and layout lessons from the pilot
